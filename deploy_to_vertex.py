...
if not all([PROJECT_ID, REGION, BUCKET_URI, MODEL_NAME]):
    print("❌ Error: One or more required variables (PROJECT_ID, REGION, BUCKET_URI, MODEL_NAME) not found in config.conf.")
    sys.exit(1)

# Converted model
HUGGINGFACE_MODEL_DIR = f"./finetuned_hf"
