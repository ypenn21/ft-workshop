...
ENDPOINT_ID = os.environ.get("GPU_ENDPOINT_ID")  # Use the specific endpoint ID for GPU

if not all([PROJECT_ID, REGION, ENDPOINT_ID]):
    print("❌ Error: One or more required variables (PROJECT_ID, REGION, GPU_ENDPOINT_ID) not found in config.conf.")
    sys.exit(1)
